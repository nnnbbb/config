...
download() {
  ...
  info "${BOLD}${UNDERLINE}https://ghproxy.com/https://ghproxy.com/https://github.com/starship/starship/issues/new/${NO_COLOR}"
  return $rc
}
...
unpack() {
  ...
  info "bug report at https://ghproxy.com/https://ghproxy.com/https://github.com/starship/starship/issues"
  return 1
}
...
if [ -z "${BASE_URL-}" ]; then
  BASE_URL="https://ghproxy.com/https://ghproxy.com/https://github.com/starship/starship/releases"
fi
